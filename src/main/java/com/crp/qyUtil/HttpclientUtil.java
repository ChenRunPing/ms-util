/**
 * Project Name:YinqiBatch
 * File Name:HttpclientUtil.java
 * Package Name:com.quyiyuan.framework.util
 * Date:2015年4月30日下午3:51:43
...
public class HttpclientUtil {
    ...
    public static String post(String url, Map<String, String> params, String charset, final URL keystoreUrl, final String keystorePassword,
            final URL truststoreUrl, final String truststorePassword) throws NetServiceException {
        if (url == null || StringUtils.isEmpty(url)) {
            return null;
        }
        DefaultHttpClient httpclient = getDefaultHttpClient(charset);
    ...
    public static void main(String[] args) {
        try {
            ...
            map.put("transCode", "00001");
            String result = HttpclientUtil.post("http://localhost:8080/QuyiPay/deal", map);
